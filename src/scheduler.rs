...
impl TaskScheduler {
    ...
    pub fn register_autostart(&self) -> Result<()> {
        ...
        unsafe {
            ...
            let task_definition = self.service
                .NewTask(0)
            ...
            reg_info.SetAuthor(&BSTR::from("MicVolumeControl"))
                .context("Failed to set author")?;
            reg_info.SetDescription(&BSTR::from("Maintains microphone volume at configured level"))
            ...
            logon_trigger.SetDelay(&BSTR::from("PT30S"))
            ...
            actions.SetContext(&BSTR::from("Author"))
            ...
            if let Some(parent) = exe_path.parent() {
                ...
                exec_action.SetWorkingDirectory(&BSTR::from(parent_str))
    ...
    pub fn unregister_autostart(&self) -> Result<()> {
        unsafe {
            ...
            root_folder.DeleteTask(&BSTR::from(TASK_NAME), 0)
